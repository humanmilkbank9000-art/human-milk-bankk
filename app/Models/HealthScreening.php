...
class HealthScreening extends Model
{
    ...
    protected $fillable = [
        ...
        'medical_history_01','medical_history_02','medical_history_03','medical_history_04','medical_history_05','medical_history_06','medical_history_07','medical_history_08','medical_history_09','medical_history_10','medical_history_11','medical_history_12','medical_history_13','medical_history_14','medical_history_15',
