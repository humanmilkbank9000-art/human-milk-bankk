...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Handle table search/filter functionality (if implemented)
    ...
    // Handle print view - ensure tables display properly
    window.addEventListener('beforeprint', function() {
        const tables = document.querySelectorAll('.table');
        tables.forEach(table => {
            table.classList.add('print-view');
        });
    });
    ...
    window.addEventListener('afterprint', function() {
        const tables = document.querySelectorAll('.table');
        tables.forEach(table => {
            table.classList.remove('print-view');
        });
    });
});

/**
 * Utility function to create responsive table wrapper
 * Can be called programmatically when creating tables dynamically
 */
...
/**
 * Utility function to add mobile-friendly action buttons
 */
function optimizeTableButtons() {
    const buttons = document.querySelectorAll('.table .btn, .table button');
...
window.wrapTableResponsive = wrapTableResponsive;
window.optimizeTableButtons = optimizeTableButtons;
