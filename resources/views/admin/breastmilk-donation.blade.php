...
@section('content')
    ...
    <div class="container-fluid page-container-standard">
        ...
        <div
            style="margin-bottom: 8px; padding-left: 20px; padding-right: 20px; margin-top: 0; position: relative; z-index: 3;">
        ...
        <div class="tab-content" id="donationTabContent" aria-live="polite" style="margin-top: 12px;">
            <!-- Pending Donations Tab -->
            <div class="tab-pane fade {{ $tabStatus == 'pending' ? 'show active' : '' }}" id="pending-donations"
                role="tabpanel">
                <div class="card card-standard" style="margin-top: 12px;">
                    ...
                    <div class="card-body">
                        <style>
                            ...
                            @media (max-width: 767.98px) {
                                #pending-donations .table-responsive {
                                    display: none !important;
                                }
            ...
            <div class="tab-pane fade {{ $tabStatus == 'declined' ? 'show active' : '' }}" id="declined-donations"
                role="tabpanel">
                <div class="card card-standard" style="margin-top: 12px;">
                    <div class="card-header bg-danger text-white" style="padding: 0.6rem 1rem;">
